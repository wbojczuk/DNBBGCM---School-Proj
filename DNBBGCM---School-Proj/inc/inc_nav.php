<nav id="mainNav">
    ...
    <a id="contactLink" href="./contact.php">Contact</a>
    <a id="archiveLink" href="#" class="dropdown-link">
    Archive
    <ul>
        <li data-href="./past_winners.php">Past Winners</li>
        <li data-href="./past_locations.php">Past Locations</li>
    </ul>
    </a>
</nav>
