...
if(!isset($_SESSION["login"])){
    ...
    ?>
    <div class="center" ><h1 style=" display:inline-block;">DNBBGCM Site Manager</h1></div>
...
<form action="./site_manager.php?action=login" method="post">
    ...
    <div class="center" ><h1 style=" display:inline-block;">DNBBGCM Site Manager</h1></div>
    <div class="center">
    <a style="margin-top: 15vh;" href="./site_documentation.php" target="_blank" class="button-one">Site Documentation</a>
    </div>
    <div class="center">
        <div id="siteManagerWrapper">
            ...
            <a class="site-manager-option" href="./site_manager/manage_archived.php">
                <div class="site-option-img"></div>
                <h4 class="site-option-title">Archive</h4>
            </a>
        </div>
    </div>
...
include("./site_manager/inc_footer.html");
    ?>
    </body>