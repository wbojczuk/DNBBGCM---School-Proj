...
if(!isset($_SESSION["login"])){
    ...
    if(isset($_GET["action"])){
        ...
        <div class="center" >
            <h1 id="yearHeader" style=" display:inline-block;"><?php echo(ucwords(str_replace(["_", ".json"], [" ", ""], $_POST["category"]))); ?></h1>
        </div>
        <div class="center">
...
<div id="galleryContainer">
    ...
    <div class="center" >
        <h1 id="yearHeader" style=" display:inline-block;"><?php echo($current_year); ?></h1>
    </div>
    <div class="center">
...
// --------------- IF VIEWING YEARS --------------
    ...
    <div class="center" >
        <h1 style=" display:inline-block;">Gallery Manager</h1>
    </div>
    <div class="center">
